...
As we can see, the error rate is 0.73%, which puts the model at 99.29% accuracy.
...
With 99.29% accuracy, we should be now confident to test it against the testing data.
